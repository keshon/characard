...
set "MAIN_PKG=%SCRIPT_DIR%\cmd\characard"
set "OUTPUT=%SCRIPT_DIR%\characard.exe"
...
set "LD=%LD% -X github.com/keshon/buildinfo.Project=characard"
set "LD=%LD% -X 'github.com/keshon/buildinfo.Description=characard'"
